...
public class RolController {
    ...
    @RequestMapping(value = "/createRol",method = RequestMethod.GET)
    public ModelAndView create(HttpServletRequest req, HttpServletResponse res){
        String id = req.getParameter("id");
        req.setAttribute("id", id);
        return new ModelAndView("createRol");
    }
    
    @RequestMapping(value = "/rol/search",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/rol/getSingle",method = RequestMethod.GET)
    ...
    public void save(HttpServletRequest req, HttpServletResponse res,Model model) throws IOException{
        ...
        try {
            ...
            input = new Gson().fromJson(jsonData, RolInput.class);
    ...
    @RequestMapping(value = "/rol/delete",method = RequestMethod.POST)
