...
import utp.gestion.logic.AsignarPedidoLogic;
...
public class AsignarPedidoController {
    @RequestMapping(value = "/asignarPedido")
    public ModelAndView item(){
        return new ModelAndView();
    }
    
    @RequestMapping(value = "/createAsignarPedido",method = RequestMethod.GET)
    public ModelAndView edit(HttpServletRequest req, HttpServletResponse res){
        String id = req.getParameter("id");
        req.setAttribute("id", id);
        return new ModelAndView("createAsignarPedido");
    }
    
    @RequestMapping(value = "/asignarPedido/search",method = RequestMethod.GET)
    public void search(HttpServletRequest req, HttpServletResponse res) throws IOException{
        res.setContentType("application/json;charset=UTF-8");
        PrintWriter out = res.getWriter();
        AsignarPedidoLogic logic = new AsignarPedidoLogic();
    ...
    @RequestMapping(value = "/asignarPedido/searchRepartidor",method = RequestMethod.GET)
    public void searchRepartidor(HttpServletRequest req, HttpServletResponse res) throws IOException{
        res.setContentType("application/json;charset=UTF-8");
        PrintWriter out = res.getWriter();
        AsignarPedidoLogic logic = new AsignarPedidoLogic();
        DataQuery data = new DataQuery();
        String idZonalVenta = req.getParameter("id");
        
        LinkedHashMap<String, Object> map =  new LinkedHashMap<>();        
        Gson json = new Gson();
        try {
            data = logic.searchRepartidor(idZonalVenta);      
            out.write(json.toJson(data));
        } catch (Exception e) {
            map.put("error", e.getMessage());
            out.write(json.toJson(map));
    ...
    @RequestMapping(value = "/asignarPedido/save",method = RequestMethod.POST)
    public void save(HttpServletRequest req, HttpServletResponse res,Model model) throws IOException{
        ...
        String jsonData="";
        AsignacionInput input = new AsignacionInput();
        ...
        try {
            ...
            input = new Gson().fromJson(jsonData, AsignacionInput.class);
    ...
    @RequestMapping(value = "/asignarPedido/delete",method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/asignarPedido/getSingle",method = RequestMethod.GET)
