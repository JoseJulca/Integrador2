...
public class PedidoInput  extends BaseInputEntity{
    ...
    private int tipoDocumentoCP;
    private String numeroDocumentoCP;
    private String direccionCP;
    private int estado;
    private List<PedidoItemInput> items; 
     ...
     */
    public void setTipoDocumentoCP(int tipoDocumentoCP) {
     ...
     * @return the items
     */
    public List<PedidoItemInput> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<PedidoItemInput> items) {
        this.items = items;
    }
