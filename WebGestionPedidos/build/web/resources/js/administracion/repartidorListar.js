 ...
 */
var oRepartidor= null;

var Repartidor = function(){
  this.Core = {
    contextUrl: window.location.origin + "/WebGestionPedidos/repartidor/",
    listParams: {
        ...
        var exito = function(rpta){
            ...
            if (data.length !== 0) {
                data.forEach(function (element) { 
                    ...
                    .append($("<tr>")
                        .append($('<td>')
                            .append($('<a href="createRepartidor?id=' + element.id + '" class="btn btn-outline-primary editar" style="margin: 2px 2px 2px 2px; padding: 2px 2px 2px 2px" data-id="' + element.id + '" ><span class="material-icons">edit</span></span>')))
                        .append($('<td>')
                        ...
                        .append($("<td>").text(element.telefono))
    ...
    exportarExcel: function () {
        ...
        var exito = function(rpta){
            ...
            if (data.length !== 0) {
                ...
                table += "<td style='font-weight: bold;background-color: #D8F6CE;'>Teléfono</td>";
    ...
    eliminar: function (id) {
        ...
        Swal.fire({
            title: "",
            text: BI.ConfirmaEliminar("este Repartidor"),
            icon: "warning",
            dangerMode: true,
...
$(function(e){
    oRepartidor = new Repartidor();
    oRepartidor.Core.init();
});  
