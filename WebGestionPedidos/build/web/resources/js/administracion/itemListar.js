...
var Item = function(){
  this.Core = {
    contextUrl: window.location.origin + "/WebGestionPedidos/item/",
    listParams: {
        ...
        var exito = function(rpta){
            ...
            if (data.length !== 0) {
                data.forEach(function (element) { 
                    ...
                    .append($("<tr>")
                        .append($('<td>')
                            .append($('<a href="createItem?id=' + element.id + '" class="btn btn-outline-primary editar" style="margin: 2px 2px 2px 2px; padding: 2px 2px 2px 2px" data-id="' + element.id + '" ><span class="material-icons">edit</span></span>')))
                        .append($('<td>')
    ...
    eliminar: function (id) {
        ...
        Swal.fire({
            title: "",
            text: BI.ConfirmaEliminar("este Producto"),
            icon: "warning",
            dangerMode: true,
