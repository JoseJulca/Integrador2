<%-- 
    Document   : index
    Created on : 06/10/2020, 12:56:08 AM
...
<html>
    ...
    <div class="card-body">
                ...
                <form id="frmBuscar">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 centrado">
                            <h3 style="align-content:center;text-align:center"><span><strong class="card-title" style="font-family:Montserrat">Productos</strong></span></h3>
                            <a href="createItem" style="float:right !important;right:0;margin-right:15px;position:absolute;margin-top:5px;"  class="btn btn-primary">
        ...
        <script src="${pageContext.request.contextPath}/resources/js/administracion/itemListar.js"></script>
   </body> 
</html>
