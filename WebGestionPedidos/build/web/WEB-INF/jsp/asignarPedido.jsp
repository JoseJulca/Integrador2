<%-- 
    ...
    Created on : 01/12/2021, 11:42:06 PM
    Author     : José
--%>
...
<html>
    ...
    <div class="card-body">
                ...
                <form id="frmBuscar">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 centrado">
                            <h3 style="align-content:center;text-align:center"><span><strong class="card-title" style="font-family:Montserrat">Asignar Pedido</strong></span></h3>
                            <a href="createAsignarPedido" style="float:right !important;right:0;margin-right:15px;position:absolute;margin-top:5px;"  class="btn btn-primary">
                        ...
                        <table class="table table-hover" style="margin:0 0 0 0;padding:0 0 0 0" id="tablaResultado">
                            <thead class="card-header card-header-primary col-lg-12">
                                <tr>
                                    ...
                                    <th scope="col" width="100px">
                                        <a  class="btn-default btn-link-head" data-order="telefono">
                                            <span id="telefonoOrden"></span>&nbsp;Telefono
                                        </a>
                                    </th>
                                    <th scope="col" width="100px">
                                        <a  class="btn-default btn-link-head" data-order="zonalVenta">
                                            <span id="zonalVentaOrden"></span>&nbsp;Zonal de Venta
                                        </a>
                                    </th>
                                    <th scope="col" width="100px">
                                        <a  class="btn-default btn-link-head" data-order="codigoPedido">
                                            <span id="codigoPedidoOrden"></span>&nbsp;Código Pedido
                                        </a>
                                    </th>
                                    <th scope="col" width="250px">
                                        <a  class="btn-default btn-link-head" data-order="direccionPedido">
                                            <span id="direccionPedidoOrden"></span>&nbsp;Dirección Pedido
                                        </a>
                                    </th>
                                    <th scope="col" width="200px">
                                        <a  class="btn-default btn-link-head" data-order="fechaPedido">
                                            <span id="fechaPedidoOrden">&#8595;</span>&nbsp;Fecha Pedido
                                        </a>
                                    </th>
                                    <th scope="col" width="50px">
                                        <a  class="btn-default btn-link-head" data-order="estadoPedido">
                                            <span id="estadoPedidoOrden"></span>&nbsp;Estado Pedido
                                        </a>
                                    </th>
                                </tr>
                            </thead>
        ...
        <script src="${pageContext.request.contextPath}/resources/js/pedido/asignarPedidoListar.js"></script>
   </body> 
</html>
