<%-- 
    Document   : repartidor
    Created on : 11/11/2021, 07:22:53 PM
    Author     : José
--%>
...
<html>
    ...
    <body>
        ...
        <div class="card-body">
            <div class="breadcrumb text-primary" style="padding:0;margin-bottom:0">Administración/Repartior</div>
            <div class="card">
                <div class="card-header">
                    <form id="frmBuscar">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 centrado">
                                <h3 style="align-content:center;text-align:center"><span><strong class="card-title" style="font-family:Montserrat">Repartidores</strong></span></h3>
                                <a href="createRepartidor" style="float:right !important;right:0;margin-right:15px;position:absolute;margin-top:5px;"  class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" width="100px">
                                            <a class="btn-default btn-link-head" data-order="telefono">
                                                <span id="telefonoOrden"></span>&nbsp;Teléfono
                                            </a>
                                        </th>
                                        <th scope="col" width="100px">
                                            <a class="btn-default btn-link-head" data-order="zonal">
                                                <span id="telefonoOrden"></span>&nbsp;Zonal de Venta
                                            </a>
                                        </th>
                                        <th scope="col" width="100px">
        ...
        <script src="${pageContext.request.contextPath}/resources/js/administracion/repartidorListar.js"></script>
    </body>
</html>