<%-- 
    Document   : usuario
    Created on : 16/09/2021, 03:07:38 AM
    Author     : José
--%>
...
<html>
    ...
    <body>
                    ...
                    <form id="frmBuscar">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 centrado">
                                <h3 style="align-content:center;text-align:center"><span><strong class="card-title" style="font-family:Montserrat">Usuarios</strong></span></h3>
                                <a href="createUsuario" style="float:right !important;right:0;margin-right:15px;position:absolute;margin-top:5px;"  class="btn btn-primary">
                            ...
                            <table class="table table-hover" style="margin:0 0 0 0;padding:0 0 0 0" id="tablaResultado">
                                <thead class="card-header card-header-primary col-lg-12">
                                    <tr>
                                        ...
                                        <th scope="col" width="100px">
                                            <a class="btn-default btn-link-head" data-order="roles">
                                                <span id="rolesOrden"></span>&nbsp;Roles
                                            </a>
                                        </th>
                                        <th scope="col" width="100px">
        ...
        <script src="${pageContext.request.contextPath}/resources/js/seguridad/usuarioListar.js"></script>
    </body>
</html>
